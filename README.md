...
This repository contains the code and instructions for reproducing experimental results for [Amaranth](https://github.com/Shao-Group/amaranth), a single-cell RNA transcript assembler.
